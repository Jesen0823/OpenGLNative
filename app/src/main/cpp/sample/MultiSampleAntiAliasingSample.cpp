...
void MultiSampleAntiAliasingSample::Draw(int screenW, int screenH) {
    ...
    if (m_FboID == GL_NONE) {
        ...
        glBindTexture(GL_TEXTURE_2D, m_TextureId2);
        glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, m_TextureId2,
                               0);
...
void
MultiSampleAntiAliasingSample::UpdateTransformMatrix(float rotateX, float rotateY, float scaleX,
                                                     float scaleY) {
