...
// 离屏渲染
    ...
    FUN_BEGIN_TIME("FBO glReadPixels")
        glReadPixels(0, 0, nativeImage.width / 4, nativeImage.height * 3, GL_RGBA, GL_UNSIGNED_BYTE,
                     pBuffer);
...
bool RGB2I444Sample::CreateFrameBufferObj() {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, m_RenderImage.width / 4, m_RenderImage.height * 3, 0,
