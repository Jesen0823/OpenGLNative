...
void
GLTransitionExample_3::UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float ratio) {
    LOGCATE("GLTransitionExample_3::UpdateMVPMatrix angleX = %d, angleY = %d, ratio = %f", angleX,
            angleY, ratio);
    angleX = angleX % 360;
    angleY = angleY % 360;
...
void GLTransitionExample_3::UpdateTransformMatrix(float rotateX, float rotateY, float scaleX,
                                                  float scaleY) {
...
void GLTransitionExample_3::LoadMultiImageWithIndex(int index, NativeImage *pImage) {
    LOGCATE("GLTransitionExample_3::LoadMultiImageWithIndex pImage = %p,[w=%d,h=%d,f=%d]",
