...
void SharedEGLContextSample::Init() {
    ...
    GLRenderLooper::GetInstance()->postMessage(MSG_SurfaceChanged, m_RenderImage.width,
...
void SharedEGLContextSample::OnAsyncRenderDone(void *callback, int fboTexId) {
    LOGCATE("SharedEGLContextSample::OnAsyncRenderDone callback=%p, fboTexId=%d", callback,
            fboTexId);
