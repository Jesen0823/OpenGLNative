...
#ifndef OPENGLNATIVE_AVATARSAMPLE_H
#define OPENGLNATIVE_AVATARSAMPLE_H
...
public:
    ...
    void UpdateMVPMatrix(glm::mat4 &mvpMatrix, int angleX, int angleY, float transX, float transY,
                         float ratio);
...
#endif //OPENGLNATIVE_AVATARSAMPLE_H
